...
declare module "@mui/material/Typography" {
    interface TypographyPropsVariantOverrides {
        fontFamilyCode: true
        fontFamilyTagline: true
        fontFamilySystem: true
...
export const theme = createTheme({
            ...
            variants: [
                ...
                },
                {
                    ...
                    style: {
                        ...
                        letterSpacing: 0,
                        fontFamily:
                            "'Jost', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif",
                        fontWeight: 600,
                        WebkitFontSmoothing: "subpixel-antialiased",
                        "&:hover, &.Mui-focusVisible": {
                            color: "#666",
    ...
    typography: {
        ...
        a: {color: "#000"},
        p: {paddingTop: "0.8rem", paddingBottom: "1.4rem"},
        h1: {
            fontFamily:
                "'Fredericka the great', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif",
